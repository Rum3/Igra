    ...
    NavHost(
        ...
        composable(Screen.Office.route) {
            ...
            OfficeScreen(
                ...
                onChapter11Click = { navController.navigate(Screen.Story.createRoute("chapter_11_1")) },
                onDebugClick = { navController.navigate(Screen.Story.createRoute("debug_chapter_10")) }
            )
        }
